...
export default function CreateMenu() {
    ...
    const handleUpdateMenuItem = () => {
        ...
        setLinks(prev => prev.map(item => item === editItem ? { ...item, label, url } : item));
    ...
    const handleCreateMenu = () => {
        ...
        setCreating(true);
        axios.post(`${import.meta.env.VITE_HOST}/seller/menus/create-menu`, newMenu)
            .then(res => {
                if (res.status === 201) {
