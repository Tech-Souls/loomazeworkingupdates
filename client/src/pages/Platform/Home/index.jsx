...
export default function Home({ settings, isCustomDomain }) {
  ...
  const SellerSpotlightProductComponent =
    spotlightProductComponents[style] || null;
...
const FeaturesProductsComponent =
  featuresProductsComponents[effectiveStyle] || null;
const RecentProductsComponent =
  recentProductsComponents[effectiveStyle] || null;
