...
function ToolsProductBox({item,idx, settings, isCustomDomain}) {
  ...
  return (
    <a
      ...
      className="group relative  rounded-lg h-[380px]   overflow-hidden block outline-none"
    >
      <div className="relative w-full h-[50%] bg-blue-500 rounded-xl overflow-hidden ">
      ...
      <div className="p-3 sm:p-4 flex flex-col flex-grow justify-start items-start">
        <p className="head text-sm relative transition-all duration-200 hover:text-red-600 group/item sm:text-base text-[var(--text)] text-left line-clamp-1 cursor-pointer">
          {item.title}

          {/* 2. Span ab is group ke hover par scale hoga */}
          <span className="absolute left-0 bottom-0 w-full h-[1px] bg-red-600 origin-left transform scale-x-0 transition-transform duration-300 group-hover/item:scale-x-100"></span>
        </p>
        ...
        <div className="flex flex-row items-center gap-2 mt-2">
         ...
         <button onClick={handleAddToCart} className={` mt-5 mb-5 w-40 h-10 overflow-hidden relative  rounded-lg px-4 py-3 bg-gray-500 text-white flex items-center justify-center  ${adding ? "cursor-not-allowed opacity-50" : "cursor-pointer"}`}>
            <span className="absolute inset-0 bg-red-600 transform translate-y-full group-hover:translate-y-0 transition-transform duration-150 flex items-center justify-center z-20">
            ...
            {adding ? (
              ...
              <span className="absolute inset-0 -group-hover:translate-y-20 flex items-center justify-center z-10">
                <p className="flex items-center justify-center gap-2">
                  <ShoppingBag /> Add to Cart
                </p>
              </span>
...
export default ToolsProductBox