...
export default function ProductBoxJewellery({
  item,
  idx,
  settings,
  isCustomDomain,
  ...
  return (
    ...
    >
      <div className="relative w-full h-42 sm:h-56 md:h-72 overflow-hidden bg-[#f3f3f3]">
        {loading && (
        ...
        <div className="absolute inset-0 flex flex-row items-end justify-center gap-5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-out bg-black/5">
          <button
            className="w-full flex justify-center items-center text-xs text-white bg-[#333] font-bold p-3 hover:bg-white hover:text-black border border-[#333] hover:border-black disabled:opacity-70 transition-all duration-200 ease-linear"
            disabled={adding}
