...
export default function PlatformRecentProductsJewellery({ storeSettings, isCustomDomain }) {
                ...
                {loading ?
                    ...
                    (!loading && products.length > 0) ?
                        products.map((item, idx) => (
                            <ProductBoxJewellery key={idx} item={item} idx={idx} settings={storeSettings} isCustomDomain={isCustomDomain} />
                        ))
                        :
