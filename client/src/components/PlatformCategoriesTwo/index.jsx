...
export default function PlatformCategoriesTwo({ settings, isCustomDomain }) {
    ...
    return (
        <section className="section-categories py-10 sm:py-14">
            <div className="main-container mx-auto px-4 relative">
                ...
                <div className="flex justify-between items-center mb-8 sm:mb-10 md:mb-15 gap-4">
                                    ...
                                    <div className="px-4">
                                        ...
                                        >
                                            ...
                                            {settings.layout.showCategoriesText &&
                                                <h3 className="text-sm font-bold p-4 sm:p-6 text-center text-gray-900 capitalize sm:text-base md:text-xl">
                                                    {cat.name}
                                                </h3>
                                            }
                                        </a>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-20">
                        {categories.map(cat => (
                            ...
                            >
                                ...
                                {settings.layout.showCategoriesText &&
                                    <h3 className="font-bold p-6 text-center text-gray-900 capitalize text-xl">
                                        {cat.name}
                                    </h3>
                                }
                            </a>
