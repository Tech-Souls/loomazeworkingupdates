...
console.lod('data from tools brand icosn ' , icons)
  
}, [settings])


  return (
    <section className="w-full font-[roboto-condensed] mt-10 ">
        <div className="w-full flex items-center justify-center flex-col gap-5">
            <h1 className="text-3xl font-bold text-center text-[#e53935]">Brands</h1>
            <h1 className="text-6xl text-center font-[bebas-neue] text-slate-700">World’s Leading Makes</h1>
            <p className="text-lg text-center  text-gray-600 tracking-tight">Discover tools and equipment from the world’s top manufacturers.
