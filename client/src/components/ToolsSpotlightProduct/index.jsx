...
function ToolsSpotlightProduct({ settings, storeSettings }) {
  ...
  return (
    <div className="w-full mt-15 font-[roboto-condensed] flex flex-wrap p-10  text-white bg-[#E53935]">
      {product ? (
        <div className="flex w-full h-full flex-wrap   relative items-start justify-center gap-5">
          ...
          <div className="lg:w-[45%] w-full h-full p-5 flex flex-col gap-5">
            ...
            <div className="w-full lg:h-17 h-10 gap-2 lg:py-2  flex-wrap flex items-center justify-center lg:justify-start">
             <Button  aading={adding} handleAddToCart={handleAddToCart}   />
