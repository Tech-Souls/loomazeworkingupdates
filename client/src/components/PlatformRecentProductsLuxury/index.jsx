...
// ─── Main Section ─────────────────────────────────────────────
export default function PlatformRecentProductsLuxury({
    storeSettings,
    isCustomDomain,
}) {
    ...
    useEffect(() => {
        if (storeSettings) fetchRecentProducts();
    }, [storeSettings]);
    ...
    return (
        <section className="py-12">
            ...
            <div className="px-6 md:px-12 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8">
