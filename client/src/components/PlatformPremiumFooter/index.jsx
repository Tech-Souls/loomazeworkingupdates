...
export default function PlatformPremiumFooter({ settings, isCustomDomain }) {
  ...
  return (
    <footer className="bg-[#000000] text-white flex gap-5 flex-col justify-between font-[Inter] w-full  border-t border-gray-200">
    ...
    <div className="max-w-md">
      <a href="/" className="block">
        {settings?.logo ? (
          ...
          <h1 className="text-blue-500 font-[Inter] font-extrabold text-2xl sm:text-3xl">
            {settings?.brandName}
          </h1>
        )}
      </a>

      <p className="pt-3 text-sm text-gray-300 leading-relaxed">
  ...
  <div className="w-full border-t border-b sm:border-none pt-5">
    ...
    <ul
      className={`overflow-hidden transition-all duration-300 flex flex-col gap-2 text-sm text-gray-300 ${
