...
@import url('https://fonts.googleapis.com/css2?family=Bebas+Neue&display=swap');
  ...
  const [direction, setDirection] = useState(0); // Using numbers: 1 for right, -1 for left

  // Sync slides with settings
  useEffect(() => {
  ...
  return (
    <section className="w-full relative flex gap-5 h-[80vh] px-5">
      {/* Sidebar Navigation */}
{/* Sidebar Navigation */}
{/* Sidebar Navigation */}
<aside className="w-70 h-fit relative font-[roboto-condensed] bg-gray-300 rounded-xl flex flex-col shrink-0 lg:block overflow-hidden transition-all duration-500">
  
  {/* Header */}
  <div className="w-full absolute flex items-center rounded-t-xl z-10 justify-between p-5 text-white text-lg font-semibold h-12 bg-[#E53935] shrink-0">
  ...
  <div 
    className={`w-full transition-all  duration-500 ease-in-out overflow-hidden
      ${showCategories ? 'max-h-[1000px]' : 'h-full'}`}
  >
